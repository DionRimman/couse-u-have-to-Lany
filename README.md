...
<!-- 
  Made with love by Rayys!
     ...
     Blog: https://dionrimman
     Instagram: @dionrimman14
     TikTok: @dionkr26
     Email: dionrimman18@gmail.com
...
<body>
   ...
   <div id="bodyblur">
     <!-- Wallpaper --><img src="https://github.com/DionRimman/couse-u-have-to-Lany/blob/main/IMG_20240315_221609.jpg" id="wallpaper"/><div id="beneranblur"></div>
   </div>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       <p id="kalimat">Aku Ada Sesuatu Nih Windi🤣❤️</p>

       <p id="pesan1">Klik 4 LOVE di Bawah ini dulu yah! 😆❤️</p>
       <div id="kolombaru">
         <li id="lv1">🤍</li>
         <li id="lv2">🤍</li>
         <li id="lv3">🤍</li>
       ...
       <p id="pesan5" class="gaya2">hmm... udah masuk 18 tahun aja yah, hehe😂</p>
       <p id="pesan6" class="gaya2">aku doakan kamu panjang umur, semoga apa yang kamu ingin capai tercapai 😆❤️</p>
       <p id="pesan7" class="gaya2"> juga sehat selalu ya!</p>
       ...
       <p id="pesan10" class="gaya2">Happy Level Up Day Windi!! 🥳</p>
     ...
     <div id="pesanditolak">
       ...
       <p id="kataditolak">Yaudah kalo gamau mauu 😜</p>
     </div>
